...
const DashboardPage = () => {
    ...
    // Filter only memorandum category announcements
    ...
    return (
        <div className="relative flex min-h-screen bg-slate-50 dark:bg-slate-950 overflow-x-hidden">
            ...
            <button
                ...
                className="fixed top-4 left-4 z-[150] md:hidden bg-[#0038A8] text-white p-2 rounded-lg shadow-lg"
            >
                <Menu size={24} />
            </button>
            ...
            {/* SIDEBAR */}
            <div className={`fixed inset-y-0 left-0 z-[100] transform transition-transform duration-300 ${mobileSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
                <Sidebar 
            ...
            {/* --- MAIN CONTENT --- */}
            <main className={`flex-1 transition-all duration-300 ${sidebarCollapsed ? 'md:ml-[80px]' : 'md:ml-[280px]'} ml-0`}>
                <div className="relative flex flex-col gap-y-10 p-0 md:p-4 min-h-screen pb-32">
                    ...
                    {isAdmin && showDeleteConfirm && memoToDelete && (
                    ...
                    <section id="visual-guides" className="scroll-mt-4 w-full bg-white rounded-[2.5rem] shadow-lg p-6 border border-slate-200 flex flex-col">
                    ...
                    {/* MEMO SECTION */}
                    <section id="memorandums" className="scroll-mt-4 space-y-8">
                                ...
                                <div className="bg-white dark:bg-slate-900 rounded-2xl p-8 shadow-sm border border-slate-200 dark:border-slate-800 mx-4 md:mx-10">
                                    ...
                                    <p className="text-slate-500 dark:text-slate-500">
                                        {searchTerm
                                            ...
                                            : !isAdmin 
                                                ? "Please login as admin to add memorandums."
                                                : "Click 'Post New Memorandum' to add your first memorandum."}
                                    </p>
                                </div>
                            </div>
                        ) : (
                    ...
                    {/* Pledge Section */}
                    <section id="pledge" className="scroll-mt-4 bg-white dark:bg-slate-900 p-8 md:p-12 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 mx-4 md:mx-10">
                    ...
                    {/* Calendar Section */}
                    <section id="calendar" className="scroll-mt-4 bg-white dark:bg-slate-900 p-6 md:p-10 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 mx-4 md:mx-10">
                    ...
                    {/* Hidden button for sidebar to trigger add modal */}
                    <button 
                        data-add-memo 
