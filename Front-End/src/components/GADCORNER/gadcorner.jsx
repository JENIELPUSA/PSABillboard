...
const GadCorner = () => {
    ...
    const { 
        ...
        UpdateAnnouncement,
        gadcornerTotalCount,
        gadcornerTotalPages: backendTotalPages,
        gadcornerCurrentPage: backendCurrentPage,
        gadcornerlimit,
        loading,
    ...
    // Ensure gadAnnouncements is always an array
    const gadAnnouncements = Array.isArray(gadcorner) ? gadcorner : [];
    ...
    const handleDelete = async (announcementId) => {
        try {
            const result = await DeleteAnnouncement(announcementId, "gadcorner");
                ...
                <section className="w-full bg-gradient-to-br from-[#0038A8] to-[#002b80] rounded-[2.5rem] py-16 px-8 text-center text-white shadow-xl relative overflow-hidden">
                    <div className="relative z-10">
                        ...
                        <h1 className="text-[clamp(2.5rem,5vw,4.5rem)] font-black leading-none mb-4 tracking-tighter uppercase">
                            GENDER AND DEVELOPMENT <span className="text-[#FCD116]">(GAD) CORNER</span>
                        </h1>
                    </div>
                </section>
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4">
                        ...
                        {isSearching && searchTerm && (
                            <div className="mt-3 text-sm text-slate-500 flex items-center gap-2">
                                ...
                                <span className="text-xs">({gadcornerTotalCount} total results)</span>
                            </div>
                        )}
                    </div>

                    {!loading && gadAnnouncements.length === 0 ? (
                                        ...
                                        <div className="p-6">
                                            <div className="flex items-center justify-between gap-4 flex-wrap">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="mb-2">
                                                        <span className="inline-flex items-center px-2 py-1 rounded-full text-[9px] font-black uppercase tracking-wider bg-purple-100 text-purple-800">
                                                            GAD CORNER
                                                        </span>
                                                    </div>
                            ...
                            {backendTotalPages > 1 && (
                                <div className="flex flex-col items-center gap-4 mt-8">
                                    ...
                                    <div className="text-sm text-slate-500">
                                        ...
                                        <span className="ml-1 font-medium text-[#0038A8]">{gadcornerTotalCount} total announcements</span>
                                    </div>
                                </div>
                            )}
                        </>
