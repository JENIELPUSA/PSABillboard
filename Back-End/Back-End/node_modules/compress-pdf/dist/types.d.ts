declare const VALID_RESOLUTIONS: readonly ["screen", "ebook", "printer", "prepress", "default"];
 ...
 */
declare class CompressPdfError extends Error {
    readonly cause?: unknown | undefined;
    constructor(message: string, cause?: unknown | undefined);
}

export { CompressPdfError, type CompressResult, type Options, type Resolution, VALID_RESOLUTIONS };
